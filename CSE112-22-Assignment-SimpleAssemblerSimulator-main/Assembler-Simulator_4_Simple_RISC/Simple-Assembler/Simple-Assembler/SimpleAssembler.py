...
def main():
    for x in myList:
        if x[0]!="hlt":
            ...
            if( x[0]=="var" and x[1]=="x") or x[0]=="st" and x[1]=="R1" and x[2]==x :
                file.write("0001000100000101\n")
                file.write("0010100100000011\n")
                file.write("1001100000000000\n")
                break
